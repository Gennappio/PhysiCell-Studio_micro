...
#     padding: 0px 5px 0px 5px;
        ...
        # Add VTK 3D View button
        self.vtk_view_button = QPushButton("Open 3D View (VTK)")
        self.vtk_view_button.setFixedWidth(bwidth)
        self.vtk_view_button.clicked.connect(self.open_vtk_view_cb)
        self.vbox.addWidget(self.vtk_view_button)
